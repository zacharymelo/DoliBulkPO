...
/**
 * \file    lib/bulkpo.lib.php
 * \ingroup bulkpo
 * \brief   Product query helpers for the Bulk PO wizard.
 */
 ...
 */
function bulkpoFetchProducts($db, $sortfield = 'p.ref', $sortorder = 'ASC', $limit = 25, $offset = 0, $filters = array())
{
	$allowed_sort = array(
		'p.ref'              => 'p.ref',
		'p.label'            => 'p.label',
 ...
 */
function bulkpoCountProducts($db, $filters = array())
{
	$vendor_id = !empty($filters['vendor_id']) ? (int) $filters['vendor_id'] : 0;
